            ...
            <ul>
                <li>
                    <div class="card">
                        ...
                        <div class="card-content">
                            <h4>Английский язык (Взрослые и детские группы)</h4>
                            <p>
                                Изучение английского языка - это ключ к миру возможностей, знание
                                английского открывает двери к новым знаниям, культурам и перспективам.
                            </p>
                ...
                <li>
                    <div class="card">
                        <div class="card-image"></div>
                        <div class="card-content">
                            <h4>Китайский язык (Взрослые и детские группы)</h4>
                            <p>
                                Изучение китайского языка - это широкие возможности для понимания
                                культуры, сознания и сердца народа, воплотившего в себе
                ...
                <li>
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <p>
                                Подготовка к экзаменам помогает преодолеть испытание знаниями, развивает силу воли, настойчивость и умение справляться с трудностями. В нашем центре реализуется подготовка к ОГЭ, ЕГЭ по
